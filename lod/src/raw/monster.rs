...
impl Monsters {
    ...
    pub fn load(lod: &LodManager, map_name: &str, game_data: &GameData) -> Result<Self, Box<dyn Error>> {
        let odm = crate::raw::odm::Odm::load(lod, map_name)?;
...
pub fn resolve_sprite_group(group_name: &str, dsft: &crate::raw::dsft::DSFT, lod: &LodManager) -> Option<(String, i16)> {
