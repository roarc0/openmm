...
fn read_dtile_data_works() {
    ...
    let dtile = Dtile::load(&assets).unwrap();
...
fn atlas_generation_works() {
    ...
    let atlas = tile_table.atlas_image(&assets).unwrap();
...
fn tileset_lookup_grass_map() {
    ...
    let odm = Odm::load(&assets, "oute3.odm").unwrap();
    let dtile = Dtile::load(&assets).unwrap();
...
fn tileset_lookup_snow_map() {
    ...
    let odm = Odm::load(&assets, "outc1.odm").unwrap();
    let dtile = Dtile::load(&assets).unwrap();
