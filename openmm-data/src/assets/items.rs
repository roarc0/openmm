...
impl ItemsTable {
    pub fn load(assets: &Assets) -> Result<Self, Box<dyn Error>> {
        let raw = assets.get_bytes("icons/items.txt")?;
...
impl TryFrom<&[u8]> for ItemsTable {
...
impl LodSerialise for ItemsTable {
    fn to_bytes(&self) -> Vec<u8> {
        let mut out = String::new();
        // MM6 items.txt header (2 lines)
        out.push_str("Items.txt\r\n");
        out.push_str("Item#\tPicFile\tName\tValue\tEquipStat\tSkillGroup\tMod1\tMod2\tMaterial\tID/Rep/St\tNotIdentifiedName\tSpriteIndex\tShape\tEquipX\tEquipY\tNotes\r\n");
        for i in &self.items {
            out.push_str(&format!(
                "{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\r\n",
                i.id,
