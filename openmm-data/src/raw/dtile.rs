...
use crate::{LodManager, raw::enums::TileFlags, raw::image::get_atlas, raw::lod_data::LodData, utils::try_read_name};
...
impl Dtile {
    pub fn load(lod_manager: &LodManager) -> Result<Self, Box<dyn Error>> {
        let raw = lod_manager.try_get_bytes("icons/dtile.bin")?;
