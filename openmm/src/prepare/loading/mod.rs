...
fn loading_setup(
    ...
    commands.remove_resource::<crate::game::map::collision::BuildingColliders>();
    commands.remove_resource::<crate::game::map::collision::TerrainHeightMap>();
    commands.remove_resource::<crate::game::map::collision::WaterMap>();
